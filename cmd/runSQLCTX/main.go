...
import (
	...
	"github.com/wandermaia/pos-golang-sqlc/internal/db"
...
func (c *CourseDB) callTx(ctx context.Context, fn func(*db.Queries) error) error {
	tx, err := c.dbConn.BeginTx(ctx, nil) // O nill é referente ao Isolate das propriedades ACID. Está utilizando o isolamento padrão.
	if err != nil {
		return err
	}
	q := db.New(tx)
